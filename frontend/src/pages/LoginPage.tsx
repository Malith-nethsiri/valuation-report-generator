                ...
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                    <Mail className={`h-5 w-5 transition-colors duration-200 ${
                      watchedEmail ? 'text-violet-500' : 'text-gray-400'
                    }`} />
                  </div>
                  <Input
                    id="email"
                    type="email"
                    autoComplete="email"
                    className={`pl-12 h-14 bg-white/50 border-gray-200/50 rounded-2xl focus:ring-2 focus:ring-violet-500 focus:border-violet-500 transition-all duration-200 ${
                ...
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                    <Lock className={`h-5 w-5 transition-colors duration-200 ${
                      watchedPassword ? 'text-violet-500' : 'text-gray-400'
                    }`} />
                  </div>
                  <Input
                    id="password"
                    ...
                    className={`pl-12 pr-14 h-14 bg-white/50 border-gray-200/50 rounded-2xl focus:ring-2 focus:ring-violet-500 focus:border-violet-500 transition-all duration-200 ${
                      errors.password ? 'border-red-300 bg-red-50/50' : touchedFields.password && !errors.password ? 'border-green-300 bg-green-50/50' : ''
                    }`}
