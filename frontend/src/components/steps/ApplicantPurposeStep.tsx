...
const ApplicantPurposeStep: React.FC<StepComponentProps & { getValues: any }> = ({ register, errors, watch, setValue }) => {
            ...
            <div className="border-t border-gray-200 pt-6 mt-6">
                ...
                <div className="mt-4">
                    <AutocompleteInput
                        ...
                        onChange={(value) => {
                            setValue('valuation_purpose', value);
                        }}
                        onBlur={() => {
                            const current = (watch('valuation_purpose') || '').trim();
                            const formatted = current ? toTitleCase(current) : '';
                            setValue('valuation_purpose', formatted, { shouldValidate: true });
                        }}
                        suggestions={PREDEFINED_VALUATION_PURPOSES}
                        placeholder="e.g., Bank Loan / Mortgage"
                        required={true}
...
export default ApplicantPurposeStep;
export { ApplicantPurposeStep };
